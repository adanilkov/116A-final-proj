...
const LinkedVis = dynamic(() => import("@/components/LinkedVisualization"), { ssr: false });
      ...
      <div className="grid grid-rows-[auto_1fr_auto] min-h-screen p-4 sm:p-10 gap-6 font-luxury bg-base-100 text-black">
        ...
        <main>
          <div className="flex items-stretch justify-center space-x-4 h-[80vh]">
            <div className={`flex-grow transition-all duration-500 ease-in-out bg-white rounded-lg shadow-xl p-4 h-[80vh] ${previewToggled ? "w-[70%]" : "w-full"}`}>
              <div className="text-2xl flex font-sans font-light mb-4 text-neutral w-full justify-between items-center">
                ...
                <button
                  ...
                  onClick={() => setPreviewToggled(prev => !prev)}
                >
            ...
            {/* Filter Panel */}
            <div className={`bg-white rounded-lg shadow-xl overflow-hidden transition-all duration-500 ease-in-out ${
        ...
        <section className="row-start-3 bg-white rounded-lg shadow-xl p-4">
          ...
          <div id="barchart-container" className="w-full h-full" />
        </section>

        {/* Place LinkedVis after containers are defined */}
        <LinkedVis />
